...
def draw_bodypose(canvas, candidate, subset, model_type='coco'):
    ...
    colors = [[255, 0, 0], [255, 85, 0], [255, 170, 0],[255, 255, 0], [170, 255, 0], [85, 255, 0], [0, 255, 0], [170, 0, 0], [0, 255, 85], \
            [0, 255, 170], [0, 255, 255], [0, 85, 255], [0, 0, 255], [85, 0, 255], \
    ...
    for i in range(njoint):
        for n in range(len(subset)):
            ...
            cv2.circle(canvas, (int(x), int(y)), 4, colors[i], thickness=5)
